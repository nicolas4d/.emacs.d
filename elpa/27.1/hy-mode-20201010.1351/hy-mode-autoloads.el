...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hy-font-lock" '("hy-font-lock-" "inferior-hy-font-lock-kwds")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hy-jedhy" '("company-hy" "hy-" "run-jedhy--pyvenv-post-deactive-hook")))
