...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hybrid-mode" '("hybrid-mode" "enable-hybrid-editing-style" "evil-insert-state-p" "disable-hybrid-editing-style")))
